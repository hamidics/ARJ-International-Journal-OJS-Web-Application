...
class AcademicFreeThemePlugin extends ThemePlugin
{
    ...
    public function init()
    {
        ...
        $this->addOption('bootstrapTheme', 'radio', array(
            'label'       => 'plugins.themes.academicfree.options.academicFree.label',
            'description' => 'plugins.themes.academicfree.options.academicFree.description',
            'options'     => array(
                'yeti' => 'plugins.themes.academicfree.options.academicFree.yeti',
            ),
        ));

          //header option
          $this->addOption('headerTheme', 'radio', array(
            'label'       => 'plugins.themes.academicfree.headerTheme.name',
            'description' => 'plugins.themes.academicfree.headerTheme.description',
            'options'     => array(
                'red'     => 'plugins.themes.academicfree.headerTheme.red',
                'edu'     => 'plugins.themes.academicfree.headerTheme.edu',
                'dots'    => 'plugins.themes.academicfree.headerTheme.dots',
                'diamond' => 'plugins.themes.academicfree.headerTheme.diamond',
                'blue'    => 'plugins.themes.academicfree.headerTheme.blue',
        ...
        $this->addOption('logoStyleBig', 'FieldOptions', array(
            'label'       => __('plugins.themes.academicfree.logo_style') . "(Pro Version Only)",
            'description' => __('plugins.themes.academicfree.logo_style_description'),
            'options'     => [
                [
                    'value' => true,
        ...
        $this->addOption('baseColour', 'FieldColor', array(
            'label'       => __('plugins.themes.academicfree.theme_color') . "(Pro Version Only)",
            'description' => __('plugins.themes.academicfree.theme_color_desc'),
            'default'     => '#8a0493',
        ));

        // Show or hide the statistic
        $this->addOption('statistics', 'FieldOptions', [
            'label'       => __('plugins.themes.academicfree.stat_label') . "(Pro Version Only)",
            'description' => __('plugins.themes.academicfree.stat.desc'),
            'options'     => [
                [
                    'value' => true,
                    'label' => __('plugins.themes.academicfree.enable'),
                ],
        ...
        $this->addOption('article_tracking_date', 'FieldOptions', [
            'label'       => __('plugins.themes.academicfree.article_tracking_date') . "(Pro Version Only)",
            'description' => __('plugins.themes.academicfree.article_tracking_date.desc'),
            'options'     => [
                [
                    'value' => true,
                    'label' => __('plugins.themes.academicfree.enable'),
        ...
        $this->addOption('galley_link_on_index', 'FieldOptions', [
            'label'       => __('plugins.themes.academicfree.galley_link_on_index') . "(Pro Version Only)",
            'description' => __('plugins.themes.academicfree.galley_link_on_index_desc'),
            'options'     => [
                [
                    'value' => true,
                    'label' => __('plugins.themes.academicfree.enable'),
        ...
        $this->addOption('dimension_badge', 'FieldOptions', [
            'label'       => __('plugins.themes.academicfree.dimension_badge_label') . "(Pro Version Only)",
            'description' => __('plugins.themes.academicfree.dimension_badge_desc'),
            'options'     => [
                [
                    'value' => true,
                    'label' => __('plugins.themes.academicfree.enable'),
        ...
        $this->addOption('doi_on_index', 'FieldOptions', [
            'label'       => __('plugins.themes.academicfree.doi_on_index') . "(Pro Version Only)",
            'description' => __('plugins.themes.academicfree.doi_on_index_desc'),
            'options'     => [
                [
                    'value' => true,
                    'label' => __('plugins.themes.academicfree.enable'),
        ...
        $this->addOption('crossmark_button', 'FieldOptions', [
            'label'       => __('plugins.themes.academicfree.crossmark_label') . "(Pro Version Only)",
            'description' => __('plugins.themes.academicfree.crossmark_button_desc'),
            'options'     => [
                [
                    'value' => true,
                    'label' => __('plugins.themes.academicfree.enable'),
        ...
        $this->addOption('maintenance_mode', 'FieldOptions', [
            'label'       => __('plugins.themes.academicfree.maintenance_label') . "(Pro Version Only)",
            'description' => __('plugins.themes.academicfree.maintenance_desc'),
            'options'     => [
                [
                    'value' => true,
                    'label' => __('plugins.themes.academicfree.enable'),
        ...
        $this->addStyle('main', 'styles/academicfree.css');
    ...
    {
        return __('plugins.themes.academicfree.name');
    }
    ...
    {
        return __('plugins.themes.academicfree.description');
    }
